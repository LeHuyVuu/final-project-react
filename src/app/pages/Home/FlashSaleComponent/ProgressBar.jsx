...
const ProgressBar = ({ qty, qty_ordered, progress_text }) => {
  ...
  return (
    <div className="w-full mt-2">
      <div className="relative w-full h-4 bg-[#ff9ea4] rounded-full">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center text-white text-xs font-semibold px-1">
          {updatedProgressText}
        </div>
      </div>
    </div>
