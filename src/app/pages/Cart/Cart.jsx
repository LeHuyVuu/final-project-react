...
const Cart = () => {
  ...
  // Static data for suggested products
  const suggestedProducts = [
    {
      id: 1,
      name: "Vintage Desk Lamp",
      price: 45.99,
      image: "https://m.media-amazon.com/images/I/71Ntk0SVtaL.jpg",
    ...
    },
    {
      ...
      price: 78.5,
      image: "https://m.media-amazon.com/images/I/71yw1J4z8ML.jpg",
      shop: "TimeMasters",
    },
    {
      id: 3,
      ...
      price: 36.99,
      image: "https://m.media-amazon.com/images/I/71eV3S88WJL.jpg",
      shop: "Pottery & More",
    },
    {
      id: 4,
      name: "Wooden Shelf",
      price: 125.0,
      image: "https://m.media-amazon.com/images/I/618NOGFp-KL.jpg",
      shop: "WoodWorks",
    },
  ];

  // Static data for carousel ads
  const carouselAds = [
    {
      id: 1,
      title: "Summer Sale",
  ...
  // Template for suggested product items
    ...
    return (
      <div className="border rounded-lg p-3 bg-white shadow-sm hover:shadow-md transition-all">
        ...
        <div className="flex justify-between items-center">
          ...
          <Button icon="pi pi-cart-plus" rounded size="small" />
        </div>
      </div>
    );
  };
              ...
              <div>
                ...
                <div className="grid grid-cols-12 items-center border-b py-4">
                  <div className="col-span-4 flex items-center">
                    ...
                    />
                    <img
                      src="https://cdnv2.tgdd.vn/mwg-static/common/News/1569924/9.jpg"
                      alt="Product"
                      className="w-20 h-20 object-cover rounded mr-4 ml-2"
                    />
                    <div>
                      <h5 className="text-lg font-semibold text-[#1a1a2e] mb-1">
                        Classic Wall Clock
                      </h5>
                      <div className="flex items-center text-sm text-gray-500 mb-1">
                        <i className="pi pi-shopping-bag mr-1"></i>
                        <span>TimeMasters Shop</span>
                      </div>
